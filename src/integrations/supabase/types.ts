...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      is_admin_or_dev: { Args: { _uid: string }; Returns: boolean }
      is_coordinator_or_admin: { Args: { _uid: string }; Returns: boolean }
      is_finance_or_admin: { Args: { _uid: string }; Returns: boolean }
